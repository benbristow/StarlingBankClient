...
public class SpendingInsightsServices : ISpendingInsightsServices
{
    ...
    public async Task<Models.SpendingCounterPartySummary> QuerySpendingInsightsByCounterpartyAsync(
        StarlingClient starlingClient, Guid accountUid,
        string year, Models.Month month)
    {
        ...
        APIHelper.AppendUrlWithQueryParameters(queryBuilder,
            new Dictionary<string, object>() { { "year", year }, { "month", Models.MonthHelper.ToValue(month) } },
    ...
    public async Task<Models.SpendingCountrySummary> QuerySpendingInsightsByCountryAsync(StarlingClient starlingClient,
    ...
    public async Task<Models.SpendingCategorySummary> QuerySpendingInsightsBySpendingCategoryAsync(
        StarlingClient starlingClient, Guid accountUid,
        string year, Models.Month month)
    {
        //prepare query string for API call
