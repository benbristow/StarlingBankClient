...
public interface IAccountsService
{
    ...
    Task<AccountStatementPeriods> AvailablePeriodsAsync(StarlingClient starlingClient, Guid accountUid);
    ...
    Task<BalanceV2> GetAccountBalanceAsync(StarlingClient starlingClient, Guid accountUid);
    ...
    Task<AccountIdentifiers> GetAccountIdentifiersAsync(StarlingClient starlingClient, Guid accountUid);
    ...
    Task<Accounts> GetAccountsAsync(StarlingClient starlingClient);
