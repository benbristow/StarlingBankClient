...
public class TransactionFeedServices : ITransactionFeedServices
{
    ...
    public async Task<Models.Receipt> GetReceiptAsync(StarlingClient starlingClient, Guid accountUid, Guid categoryUid,
        Guid feedItemUid)
    {
        //prepare query string for API call
        var queryBuilder = new StringBuilder();
    ...
    public async Task<Models.FeedItem> GetFeedItemAsync(StarlingClient starlingClient, Guid accountUid,
    ...
    public async Task<Models.FeedItemAttachments> GetFeedItemAttachmentsAsync(StarlingClient starlingClient,
    ...
    public async Task<Models.MastercardFeedItem> GetMastercardFeedItemAsync(StarlingClient starlingClient,
        Guid accountUid, Guid categoryUid,
        Guid feedItemUid)
    {
        //prepare query string for API call
    ...
    public async Task<Models.FeedItems> QueryFeedItemsAsync(StarlingClient starlingClient, Guid accountUid,
        Guid categoryUid, DateTime changesSince)
    {
        //prepare query string for API call
        var queryBuilder = new StringBuilder();
            ...
            {
                {
                    ...
                    minTransactionTimestamp.ToString("yyyy'-'MM'-'dd'T'HH':'mm':'ss.FFFFFFFK")
                },
                {
                    "maxTransactionTimestamp",
                    maxTransactionTimestamp.ToString("yyyy'-'MM'-'dd'T'HH':'mm':'ss.FFFFFFFK")
                }
            }, _arrayDeserializationFormat);
        //validate and preprocess url
        var queryUrl = APIHelper.GetUrl(starlingClient, queryBuilder);
