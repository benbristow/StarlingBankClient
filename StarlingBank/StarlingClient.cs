...
public class StarlingClient
{
    ...
    public static StarlingClientBuilder Builder => new();
    ...
    private class StarlingClientValidator : AbstractValidator<StarlingClient>
    {
        public StarlingClientValidator()
        {
            RuleFor(x => x.OAuthAccessToken).NotNull().NotEmpty().NotEqual("YOUR_OAUTH_TOKEN")
                .WithMessage("OAuthAccessToken is required.");
        }
    }
